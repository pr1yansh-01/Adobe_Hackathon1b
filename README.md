...
- **Single Case Processing**: ~2-5 minutes
- **All Three Cases**: ~6-15 minutes
...
- Model inference time (CPU-bound)
- Text extraction complexity

### Output Files

Each case generates a `round1b_result.json` file containing:
- Document metadata
- Extracted sections with importance rankings
- Page references
- Subsection analysis with summaries
...
```
- Copies pre-trained models and all source code
- Maintains directory structure for proper execution
...
- Can be overridden for single case processing
...
5. **Information Retrieval**: Semantic search within document collections
...
{
  "metadata": {
    "documents": ["list_of_processed_pdfs"],
    "persona": "user_role",
...
This tool provides an efficient, scalable solution for automated document analysis and content extraction workflows.